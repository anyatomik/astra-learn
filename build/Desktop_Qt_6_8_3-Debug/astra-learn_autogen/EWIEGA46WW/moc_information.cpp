...
static constexpr auto qt_meta_stringdata_ZN11informationE = QtMocHelpers::stringData(
    "information"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11informationE[] = {
...
Q_CONSTINIT const QMetaObject information::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11informationE.offsetsAndSizes,
    qt_meta_data_ZN11informationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11informationE_t,
        // Q_OBJECT / Q_GADGET
...
void *information::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11informationE.stringdata0))
