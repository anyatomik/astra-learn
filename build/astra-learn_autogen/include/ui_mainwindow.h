...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        learn->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon;
        ...
        tests->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/icons/img/applyed.png"), QSize(), QIcon::Normal, QIcon::Off);
        tests->setIcon(icon1);
        ...
        information->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/new/icons/img/information.png"), QSize(), QIcon::Normal, QIcon::Off);
