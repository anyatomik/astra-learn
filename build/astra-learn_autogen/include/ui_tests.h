...
public:
    ...
    void setupUi(QWidget *tests)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/icons/img/applyed.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/new/icons/img/settings.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        verticalSpacer_2 = new QSpacerItem(12, 40, QSizePolicy::Policy::Expanding, QSizePolicy::Minimum);
        ...
        verticalSpacer = new QSpacerItem(10, 40, QSizePolicy::Expanding, QSizePolicy::Minimum);
